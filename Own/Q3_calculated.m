%Q3_Calculated calculates the value of TSFC and Net uninstalled thrust for
%a non mixing turbofan engine.
...
PRhp = 26.7 .* (n .^ 1.22);%High pressure compressor pressure ratio
...
TET = 1413;%Turbine entry temperature
