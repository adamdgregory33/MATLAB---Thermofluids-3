% This function outputs the Net Uninstalled Thrust of the engine and its
% Thrust Specific Fuel Consumption, given the pressure ratio of the High
% Pressure Compressor and the TET.

% Author : Liam Bradbury
% SID : 201008735

function ANS = TET2FN(PRhpc, TET)
